...
Rectangle {
  ...
  readonly property string diskPath: {
    ...
    if (sysMonWidget && sysMonWidget.diskPath) return sysMonWidget.diskPath;
    return "/";
  }
        ...
        ColumnLayout {
          ...
          RowLayout {
            ...
            NText {
              ...
              pointSize: Style.fontSizeXS; color: Color.mPrimary; font.family: Settings.data.ui.fontFixed
            }
            NIcon { icon: "cpu-temperature"; pointSize: Style.fontSizeXS; color: Color.mSecondary }
            NText {
              text: `${Math.round(SystemStatService.cpuTemp)}°C`
              pointSize: Style.fontSizeXS; color: Color.mSecondary; font.family: Settings.data.ui.fontFixed
            }
          ...
          NGraph {
            ...
            color: Color.mPrimary; color2: Color.mSecondary
      ...
      NBox {
        ...
        ColumnLayout {
          ...
          NGraph {
            ...
            minValue: 0; maxValue: SystemStatService.rxMaxSpeed
            minValue2: 0; maxValue2: SystemStatService.txMaxSpeed
            color: Color.mPrimary; color2: Color.mSecondary
            strokeWidth: Math.max(1, Style.uiScaleRatio)
            fill: true; fillOpacity: 0.15
      ...
      NBox {
        ...
        ColumnLayout {
          ...
          RowLayout {
            ...
            NIcon { icon: "cpu-usage"; pointSize: Style.fontSizeM; color: Color.mPrimary }
            NText { text: "Load:"; pointSize: Style.fontSizeXS; color: Color.mOnSurfaceVariant }
            NText {
              text: `${SystemStatService.loadAvg1.toFixed(2)} / ${SystemStatService.loadAvg5.toFixed(2)} / ${SystemStatService.loadAvg15.toFixed(2)}`
              pointSize: Style.fontSizeXS; color: Color.mOnSurface
          ...
          RowLayout {
            ...
            NIcon { icon: "gpu-temperature"; pointSize: Style.fontSizeM; color: Color.mPrimary }
            NText { text: "GPU:"; pointSize: Style.fontSizeXS; color: Color.mOnSurfaceVariant }
            NText {
          ...
          RowLayout {
            Layout.fillWidth: true; spacing: Style.marginS
            NIcon { icon: "storage"; pointSize: Style.fontSizeM; color: Color.mPrimary }
            NText { text: "Disk:"; pointSize: Style.fontSizeXS; color: Color.mOnSurfaceVariant }
            NText {
              text: {
              ...
              pointSize: Style.fontSizeXS; color: Color.mOnSurface
              Layout.fillWidth: true; horizontalAlignment: Text.AlignRight; elide: Text.ElideMiddle
            }
          }
          ...
          RowLayout {
            ...
            NIcon { icon: "exchange"; pointSize: Style.fontSizeM; color: Color.mPrimary }
            NText { text: "Swap:"; pointSize: Style.fontSizeXS; color: Color.mOnSurfaceVariant }
            NText {
